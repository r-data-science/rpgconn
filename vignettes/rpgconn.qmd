---
title: "rpgconn: PostgreSQL Connection Management"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{rpgconn: PostgreSQL Connection Management}
...
- **Quick Start**: See `vignette("quick-start")` for 5-minute setup
- **Advanced Usage**: See `vignette("advanced-usage")` for:
  - SSL configuration
  - IPv6 hosts
